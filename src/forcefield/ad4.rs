...
impl ForceField for AD4ForceField {
    ...
    fn vdw_energy(&self, atom1: &Atom, atom2: &Atom, distance: f64) -> Result<f64, ForceFieldError> {
        ...
        let params = self.params.vdw_coeffs.get(&(type1, type2))
    ...
    fn hbond_energy(&self, atom1: &Atom, atom2: &Atom, distance: f64) -> Result<f64, ForceFieldError> {
        ...
        let params = self.params.hbond_coeffs.get(&(donor_type, acceptor_type))
    ...
    fn desolvation_energy(&self, atom1: &Atom, atom2: &Atom, distance: f64) -> Result<f64, ForceFieldError> {
        ...
        let vol1 = self.params.atom_volumes.get(&atom1.atom_type).copied().unwrap_or(0.0);
        let vol2 = self.params.atom_volumes.get(&atom2.atom_type).copied().unwrap_or(0.0);
        let solv1 = self.params.atom_solvpars.get(&atom1.atom_type).copied().unwrap_or(0.0);
        let solv2 = self.params.atom_solvpars.get(&atom2.atom_type).copied().unwrap_or(0.0);
